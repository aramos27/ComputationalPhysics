...
function compute_gaps(cells::Vector{Union{Nothing, Car}})
    L = length(cells)
    nextCar = nothing
...
function init_cells(L::Int, ρ::Float64)
...
#Function to record traffic over Nt timesteps
...
#Function to plot traffic space-time picture
...
ρ = 0.2 #Probability of cell being occupied at initialization
